...
public sealed class GameLogger: ILogger, IDisposable
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private void ActualLogging(string o, LogLevel logLevel)
    {
    ...
    {
        ActualLogging(o, LogLevel.Debug);
    }
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Error(string o)
    {
        ActualLogging(o, LogLevel.Error);
    }
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Warning(string o)
    {
        ActualLogging(o, LogLevel.Warning);
    }
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void Info(string o)
    {
        ActualLogging(o, LogLevel.Information);
    }
